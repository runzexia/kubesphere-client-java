...
public class DevopsKubesphereIoApi {
  private ApiClient apiClient;

  public DevopsKubesphereIoApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DevopsKubesphereIoApi(ApiClient apiClient) {
  ...
  public com.squareup.okhttp.Call getAPIGroupCall(
    ...
    String localVarPath = "/apis/devops.kubesphere.io/";
  ...
  private com.squareup.okhttp.Call getAPIGroupValidateBeforeCall(
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
   ...
   */
  public com.squareup.okhttp.Call getAPIGroupAsync(final ApiCallback<V1APIGroup> callback)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call =
        getAPIGroupValidateBeforeCall(progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<V1APIGroup>() {}.getType();
