...
import io.kubesphere.client.util.authenticators.Authenticator;
import io.kubesphere.client.util.authenticators.AzureActiveDirectoryAuthenticator;
import io.kubesphere.client.util.authenticators.GCPAuthenticator;
import java.io.File;
